  ...
  return (
    <div>
      <div style={{ textAlign: "center", marginBottom: "28px" }}>
        ...
        <h2 className="serif" style={{ fontSize: "24px", fontWeight: 700, marginBottom: "6px" }}>Booking confirmed</h2>
      ...
      <div style={{ background: "var(--surface-2)", border: "1px solid var(--border-strong)", borderRadius: "10px", overflow: "hidden", marginBottom: "24px" }}>
        <div style={{ padding: "12px 18px", borderBottom: "1px solid var(--border)", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <span style={{ fontSize: "11px", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.08em", color: "var(--text-muted)" }}>Upcoming at Nordklip</span>
    ...
    <div style={{ minHeight: "100vh" }}>
      ...
      <nav style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "20px" }}>
          <Link href="/bookings" style={{ fontSize: "13px", color: "var(--text-muted)", fontWeight: 500, textDecoration: "none" }}>My bookings</Link>
                  ...
                  <div style={{ minHeight: "280px" }}>
                    ...
                    {step === 1 && (
                      <>
                        ...
                        <p style={{ fontSize: "14px", color: "var(--text-muted)", marginBottom: "20px" }}>What are you coming in for today?</p>
                              ...
                              <button key={s.id} onClick={() => setService(s)} style={{
                                ...
                                <div style={{ flex: 1, minWidth: 0 }}>
                                  <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "3px", flexWrap: "wrap" }}>
                                    <span className="serif" style={{ fontSize: "15px", fontWeight: 700, color: "var(--text)" }}>{s.name}</span>
                                    ...
                                    {s.popular && <span style={{ fontSize: "10px", color: "#FBBF24", background: "rgba(251,191,36,0.1)", border: "1px solid rgba(251,191,36,0.28)", borderRadius: "3px", padding: "1px 6px", fontWeight: 700, letterSpacing: "0.04em" }}>Popular</span>}
                                  ...
                                  <p style={{ fontSize: "12px", color: "var(--text-muted)", margin: 0, lineHeight: 1.45 }}>{s.desc}</p>
                                </div>
                                ...
                                <div style={{ padding: "16px 18px" }}>
                                  {isAny ? (
                                    ...
                                    <div style={{ display: "flex", alignItems: "center", gap: "14px" }}>
                                      ...
                                      <div style={{ flex: 1 }}>
                                        <div style={{ fontSize: "15px", fontWeight: 700, color: "var(--text)", marginBottom: "2px", fontFamily: "var(--font-playfair)" }}>{s.name}</div>
                                        <div style={{ fontSize: "12px", color: sel ? "var(--gold)" : "var(--text-muted)" }}>{s.role}</div>
                                        <p style={{ fontSize: "12px", color: "var(--text-muted)", margin: "6px 0 0", lineHeight: 1.45 }}>{s.story}</p>
                                      </div>
                                    </div>
                                  ) : (
                                    /* Real barber card */
                                    <>
                                      <div style={{ display: "flex", gap: "14px", alignItems: "flex-start", marginBottom: "13px" }}>
                                        ...
                                        <div style={{ flex: 1, minWidth: 0 }}>
                                          <div className="serif" style={{ fontSize: "16px", fontWeight: 700, color: "var(--text)", marginBottom: "2px" }}>{s.name}</div>
                                          <div style={{ fontSize: "12px", color: sel ? "var(--gold)" : "var(--text-muted)", fontWeight: 600, marginBottom: "2px" }}>{s.role}</div>
                                      ...
                                      <p style={{
                                        ...
                                        margin: "0 0 12px", paddingTop: "12px",
                        ...
                        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "20px" }}>
                          ...
                          <div style={{ display: "flex", gap: "10px", alignItems: "center" }}>
                            <span style={{ fontSize: "11px", color: "var(--text-secondary)", display: "flex", alignItems: "center", gap: "5px" }}>
                              <span style={{ width: "10px", height: "10px", borderRadius: "2px", background: "var(--gold-dim)", border: "1px solid var(--gold)", display: "inline-block" }}/>Open
                            </span>
                            <span style={{ fontSize: "11px", color: "var(--text-muted)", display: "flex", alignItems: "center", gap: "5px" }}>
                              <span style={{ width: "10px", height: "10px", borderRadius: "2px", background: "var(--surface-2)", border: "1px solid var(--border)", display: "inline-block", opacity: 0.4 }}/>Taken
                            </span>
                          </div>
                        </div>
                    ...
                    {step === 5 && (
                      <>
                        ...
                        <p style={{ fontSize: "14px", color: "var(--text-muted)", marginBottom: "24px" }}>Almost done. Just confirm your contact info.</p>
                        <div style={{ display: "flex", flexDirection: "column", gap: "15px", marginBottom: "24px" }}>
                          ...
                          <div>
                            ...
                            <textarea placeholder="Any requests or preferences..." value={notes} onChange={e => setNotes(e.target.value)} rows={3} style={{ resize: "vertical" }}/>
                          </div>
                        </div>
                        {/* Summary */}
